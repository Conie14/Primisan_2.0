...
class Mecanicos extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.mecanicos.view', [
            'mecanicos' => Mecanico::latest()
    ...
    public function store()
    {
		...
		session()->flash('message', 'Mecanico Successfully created.');
    }

    public function edit($id)
    {
        $record = Mecanico::findOrFail($id);
    ...
    public function update()
    {
        ...
        if ($this->selected_id) {
			$record = Mecanico::find($this->selected_id);
            $record->update([ 
			'nombre' => $this-> nombre,
			'email' => $this-> email,
			'telefono' => $this-> telefono,
            ...
            $this->resetInput();
            $this->updateMode = false;
			session()->flash('message', 'Mecanico Successfully updated.');
        }
    }
