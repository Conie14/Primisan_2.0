            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="idarea" class="col-md-4 col-form-label text-md-right">{{ __('Area') }}</label>

                            <div class="col-md-6">
                                <input id="idarea" type="text" class="form-control @error('idarea') is-invalid @enderror" name="idarea" value="{{ old('idarea') }}" required autocomplete="idarea" autofocus>
