			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Add Areas
						</div>
					</div>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									<a class="dropdown-item" onclick="confirm('Confirm Delete Area id {{$row->id}}? \nDeleted Areas cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a>   
									</div>
								</div>
								</td>
							@endforeach
