    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create New Electricidade</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="idservicio" type="text" class="form-control" id="idservicio" placeholder="Idservicio">@error('idservicio') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
